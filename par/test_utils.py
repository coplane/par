...
class TestPathGeneration:
    ...
    def test_get_worktree_path(self, mock_get_data_dir, temp_dir):
        ...
        expected_path = temp_dir / Config.WORKTREES_DIR_NAME / expected_repo_id / "feature-branch"
...
class TestWorkspaceUtilities:
    ...
    def test_get_workspace_worktree_path(self, mock_get_data_dir, temp_dir):
        ...
        expected = (temp_dir / Config.WORKSPACES_DIR_NAME / workspace_id / 
                   "feature-auth" / "frontend" / "feature-auth")
        
        assert worktree_path == expected
        # Function should create parent directories
        assert worktree_path.parent.parent.parent.exists()  # workspace_id dir should exist
    ...
    def test_get_workspace_session_name(self):
        ...
        expected_workspace_id = hashlib.sha256(str(workspace_root.resolve()).encode()).hexdigest()[:4]
    ...
    def test_get_workspace_file_path(self, mock_get_data_dir, temp_dir):
        ...
        workspace_id = hashlib.sha256(str(workspace_root.resolve()).encode()).hexdigest()[:8]
        expected = (temp_dir / Config.WORKSPACES_DIR_NAME / workspace_id / 
                   "feature-auth" / "feature-auth.code-workspace")
    ...
    def test_save_vscode_workspace_file(self, mock_get_data_dir, temp_dir):
        ...
        repos_data = [
            {
                "repo_name": "frontend",
                "worktree_path": str(temp_dir / "workspaces" / "abc123" / "feature-auth" / "frontend" / "feature-auth")
            }
        ]
...
if __name__ == "__main__":
    print("✅ Core utility function tests defined")
    print("Run with: pytest par/test_utils.py -v")